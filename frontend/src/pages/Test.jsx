...
const DB_CONFIG = [
  ...
  { label: "Şifre", value: "backend/.env → DB_PASSWORD" },
];
      ...
      <div className="test-wrap">
        <header className="test-hero">
          ...
          <p className="test-hero__lead">
            React frontend, Django API ve PostgreSQL veritabanının birlikte
            çalışıp çalışmadığını bu sayfadan doğrulayabilirsiniz.
          </p>
        ...
        <section className="test-section">
          ...
          <div className="pipeline">
            {[
              ...
              { icon: "fa-solid fa-database", label: "PostgreSQL", sub: "personel_db", ok: dbOk },
            ].map((node, i, arr) => (
        ...
        <section className="test-section">
          ...
          <div className="service-grid">
            ...
            <ServiceCard
              title="PostgreSQL"
              subtitle="personel_db veritabanı bağlantısı"
              icon="fa-solid fa-database"
        ...
        <section className="test-section">
          ...
          <div className="config-panel">
            <p className="config-panel__intro">
              Veritabanını görsel olarak yönetmek için DBeaver&apos;da yeni bir
              PostgreSQL bağlantısı oluşturun ve aşağıdaki değerleri girin.
            </p>
        ...
        <footer className="test-footer">
          ...
          <p className="test-footer__url">
            Ana sayfa: <code>localhost:5173</code> &nbsp;·&nbsp; Test: <code>localhost:5173/test</code>
          </p>
        </footer>
      </div>
    </div>
